...
This project is a Full Stack Todo List Application which was built using the MongoDB, NodeJS, ExpressJS, CSS, Javascript. It implements all the basic functionalities of a todo list, i.e, CRUD Operations (Create Read Update Delete).
...
> ## Checkout the Website [Web Application](https://com)
>
> ## Checkout the Application Demo Video [YouTube](https:)
